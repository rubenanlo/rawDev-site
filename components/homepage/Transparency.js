            ...
            <div className="lg:ml-auto lg:pl-4 lg:pt-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-400">
                  ...
                  is key for us. We want you to be in control of your website.
                  We will provide you with the tools to do so. You will be able
                  to track progress, review any preview of your website and
                  grant additional access to the GitHub repo.
                </p>
