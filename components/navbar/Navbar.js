                ...
                <div className="relative h-full">
                  ...
                  >
                    <div className="absolute left-1/2 mt-5 flex w-screen max-w-max -translate-x-1/2 px-4">
                      <div className="w-1/2 max-w-md flex-auto overflow-hidden bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5 lg:max-w-3xl">
                        <div className="flex flex-col">
                          {contactMe.map((item) => (
                            <div
                              key={item.name}
                              className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-100 items-center"
                            >
                              <div className="mt-1 flex w-11 flex-none items-center justify-center group-hover:bg-gray-50">
                                <item.icon
