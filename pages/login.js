                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        autoComplete="email"
                        required
                        className="block w-full rounded-sm border-0 py-1.5 shadow-sm bg-transparent ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-tertiary sm:text-sm sm:leading-6"
                      />
                    </div>
                  </div>
